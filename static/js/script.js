$(document).ready(function() {
    ...
    $('#analyse-form   ').on('submit', function(e) {
        e.preventDefault();
        ...
        outputEditor.setValue('Analyzing your code... Please wait...');
        ...
        $.ajax({
            ...
            success: function(response) {
                outputEditor.setValue(response.analysis_result);
            },
            error: function() {
                outputEditor.setValue('An error occurred during analysis. Please try again.');
            }
        });
    });
